...
class Event5DetailsPage extends StatefulWidget {
  @override
  _Event5DetailsPageState createState() => _Event5DetailsPageState();
}

class _Event5DetailsPageState extends State<Event5DetailsPage> {
  ...
  void addToWishlist(BuildContext context) async {
    try {
      ...
      QuerySnapshot querySnapshot =
          await wishlistCollection.where('title', isEqualTo: 'Art Event').get();
      ...
      await wishlistCollection.add({
        'title': 'Art Event',
        'description':
            'Immersive Art Experience: Exploring Creativity and Expression"',
        'isFree': 'Free',
      });
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  children: [
                    Text(
                      ' Immersive art event, where we invite you to embark on a journey of exploration and inspiration. From captivating installations to thought-provoking performances, this event celebrates the boundless creativity and diverse expressions of the human spirit.', // Rating value
                      style: TextStyle(
                        fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold,
